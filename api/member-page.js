...
const PAGES = { "extreme-os": "extreme-os.html", momentum: "momentum.html", momentum2: "momentum2.html", haa: "haa.html", "momentum-stocks": "momentum-stocks.html", "mean-reversion": "mean-reversion.html" };
...
const MEMBER_NAV = `<nav class="site-nav"><strong class="brand">Extreme Trading Inc.</strong><div class="navlinks"><a href="index.html">Home</a><a href="${MEMBER_DIRECTORY_URL}">Strategies</a><a href="subscribe.html">Subscribe</a><a href="about.html">About</a><a href="contact.html">Contact</a><button id="detail-billing-button" type="button" style="${NAV_BUTTON_STYLE}">Manage billing</button><button id="detail-signout-button" type="button" style="${NAV_BUTTON_STYLE}">Sign out</button></div></nav>`;
