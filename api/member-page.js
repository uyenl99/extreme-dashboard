...
const MEMBER_NAV = `<nav><div><strong>Extreme Trading Inc.</strong></div><div><a href="members.html">Strategies</a><a href="subscribe.html">Subscribe</a><a href="about.html">About</a><a href="contact.html">Contact</a><button type="button" onclick="localStorage.removeItem('eti_member_session');location.href='members.html'" style="margin-left:20px;padding:0;border:0;background:none;color:white;font:inherit;cursor:pointer">Sign out</button></div></nav>`;
