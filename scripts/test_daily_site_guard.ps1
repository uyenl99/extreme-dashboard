...
foreach ($publicPage in @(
    ...
    Assert-Contains $publicPage @('<script src="/site-auth-nav.js?v=5"></script>')
}
...
Assert-Contains "combined-portfolio.html" @('<nav class="site-nav">', 'href="strategies.html"', 'href="about.html"', 'href="contact.html"', '<script src="/site-auth-nav.js?v=5"></script>')
